        ...
        {projects.length > 4 && (
          ...
          >
            <button
              ...
              className="group flex items-center gap-3 px-6 py-3 rounded-xl border border-zinc-200 dark:border-zinc-800/40 bg-white dark:bg-zinc-900/50 text-sm font-medium text-zinc-600 dark:text-zinc-400 hover:text-accent hover:border-accent/30 transition-all duration-300"
            >
              {showAll ? (
                <>
