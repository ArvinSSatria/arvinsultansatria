  ...
  projects: [
    {
      ...
      subtitle: "Fullstack Analytics Web App",
      description: "A high-performance fullstack application built with a Rust backend and TypeScript frontend for checking social media engagement rates.",
      image: "/checker-website.png",
      fullScreenshot: "/screenshots/checkER.png",
      link: "https://github.com/ArvinSSatria/CheckER",
      preview: "https://engagement-checker.arvinsultansatria.my.id/",
      tags: ["JavaScript", "Rust", "TypeScript", "Tailwind CSS"],
    },
    {
      id: 6,
      title: "Gemura Website",
      subtitle: "Fullstack Community Platform",
      description: "A comprehensive fullstack website combining a React frontend with a robust Laravel PHP backend for community organization management.",
      image: "/gemura-website.png",
      fullScreenshot: "/screenshots/gemura-website.png",
      link: "https://github.com/ArvinSSatria/gemura-website",
      preview: "#",
      tags: ["React", "JavaScript", "PHP", "Laravel", "Tailwind CSS", "Vite"],
    },
    {
      id: 1,
      title: "Legal Care Service",
      subtitle: "Frontend Web Application",
      description: "A modern, responsive frontend application built with Next.js and TypeScript, focused on delivering a fast and SEO-friendly experience.",
      image: "/legal-care.png",
      fullScreenshot: "/screenshots/legal-care.png",
      link: "https://github.com/ArvinSSatria/legal-care",
      preview: "#",
    ...
    },
    {
      ...
      description: "A professional UI/UX design prototype for a camping rental service, created in Figma with a focus on responsive layouts and user conversion.",
      image: "/camping-website.png",
      fullScreenshot: "",
      link: "https://github.com/Dian-AriMahiza/Camping-Rental",
    ...
    },
    {
      ...
      description: "A complete mobile application interface design and interactive prototype built in Figma, featuring workout tracking and social networking concepts.",
    ...
    },
    {
      ...
      subtitle: "Static Frontend Website",
      description: "A lightweight, static frontend website developed using pure HTML, CSS, and vanilla JavaScript to showcase a business portfolio.",
      image: "/agency-website.png",
      fullScreenshot: "",
      link: "https://github.com/ArvinSSatria/kata-kreatif",
